...
function buildNav(sections) {
  ...
  var abbreviations = {
    'California Sparkling Wines': 'CA Spark',
    'French Champagnes': 'FR Champ',
    'California Chardonnays': 'CA Chard',
    'French Chardonnays': 'FR Chard',
    'California Sauvignon Blanc': 'CA Sauv B',
    'Italian White Wine': 'IT White',
    'Johannesburg Riesling': 'Riesling',
    'California Rose': 'CA Rosé',
    'California Cabernet Sauvignon': 'CA Cab',
    'California Reserves/Verticals': 'Reserves',
    'California Merlots': 'CA Merlot',
    'California Sirahs': 'CA Sirah',
    'California Zinfandel': 'CA Zin',
    'French Gamay': 'FR Gamay',
    'California Pinot Noir': 'CA Pinot',
    'Cotes de Rone': 'Rhône',
    'Cotes de Beaune': 'Beaune',
    'Cotes de Nuits': 'Nuits',
    'Italian Red Wines': 'IT Red',
    'Boredeaux': 'Bordeaux',
    'California/French Dessert Wines': 'Dessert',
    'Non-Alcoholic Wines': 'N/A',
    'Wines By Glass': 'By Glass',
    'Half Bottles': 'Half Btl',
    'Premium Wines & Bubbles': 'Premium',
    'Premium Wines & Bubbles Flights': 'Flights'
  };

  for (var i = 0; i < sections.length; i++) {
    var section = sections[i];
    var btn = document.createElement('button');
    btn.textContent = abbreviations[section] || section.substring(0, 8);
...
function highlightActiveSection() {
  ...
  var navButtons = document.querySelectorAll('#section-nav button');
